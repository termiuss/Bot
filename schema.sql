...
-- Таблица для дополнительной информации о пользователях (КД, Айди, Сквад, Прочее)
...
-- Таблица для дополнительной текстовой информации о пользователях
...
-- Таблица для запросов на выплаты
...
CREATE INDEX IF NOT EXISTS idx_payout_requests_telegram_id ON payout_requests (telegram_id);
